  ...
  <body>
	  <div class="d-flex">
	  	...
	  	<div class="container-fluid">
		    <div class="text-center my-5 fs-3 fw-bold">Add Course</div>
		    <div class="container border  border-0 border-secondary" >
				<div class="container-fluid">
					<form action="add-course" method="post" class="d-flex flex-column align-items-center">
						...
						<input type="text" name="Lecturer" placeholder="Lecturer" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
						<input type="number" name="Year" placeholder="Year" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
