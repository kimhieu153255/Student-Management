  ...
  <body>
	  <div class="d-flex">
	  	...
	  	<div class="container-fluid">
		    <div class="text-center my-5 fs-3 fw-bold">Find Student</div>
		    <div class="container border  border-0 border-secondary" >
				<div class="container-fluid">
					<form action="find-student" method="post" class="d-flex mx-auto justify-content-center">
						<input type="text" name="StudentName" placeholder="Student Name" class="fw-medium fs-5 border rounded px-3 me-1" value="${StudentName}"/>
			    	...
			    	<c:if test="${not empty Students}">
					    <div class="container border  border-0 border-secondary" >
						    <div class="text-center my-3">
				   	    		<a class="btn btn-outline-secondary" href="find-student?sort=asc&name=True&StudentName=${StudentName}">AscName</a>
				   	    		<a class="btn btn-outline-secondary" href="find-student?sort=desc&name=True&StudentName=${StudentName}">DescName</a>
				   	    		<a class="btn btn-outline-secondary" href="find-student?sort=asc&name=False&StudentName=${StudentName}">AscGrade</a>
				   	    		<a class="btn btn-outline-secondary" href="find-student?sort=desc&name=False&StudentName=${StudentName}">DescGrade</a>
				   	    	</div>
