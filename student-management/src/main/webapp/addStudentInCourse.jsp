  ...
  <body>
	  <div class="d-flex">
	  	...
	  	<div class="container-fluid">
		    <div class="text-center my-5 fs-3 fw-bold">Add Student In Course</div>
		    <div class="container border  border-0 border-secondary" >
				<div class="container-fluid">
					<form action="course-add-student" method="post" class="d-flex flex-column align-items-center">
						<input type="number" name="CourseId" value="${CourseId}" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3" readonly/>
						<input type="number" name="Id" placeholder="Id" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
						<input type="number" name="Score" placeholder="Score" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3" />
