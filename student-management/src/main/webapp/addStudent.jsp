  ...
  <body>
	  <div class="d-flex">
		  	...
		  	<div class="container-fluid">
			    <div class="text-center my-5 fs-3 fw-bold">Add Student</div>
			    <div class="container border  border-0 border-secondary" >
					<div class="container-fluid">
						<form action="add-student" method="post" class="d-flex flex-column align-items-center">
							<input type="text" name="Name" placeholder="Name" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
							<input type="number" name="Grade" placeholder="Grade" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
							<input type="date" name="Birdthday" placeholder="Birdthday" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
							<input type="text" name="Address" placeholder="Address" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
							<input type="text" name="Notes" placeholder="Notes" style="line-height: 50px; width: 100%;"  class="fw-medium fs-5 mb-3 border rounded px-3"/>
