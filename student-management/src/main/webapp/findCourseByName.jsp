  ...
  <body>
	  <div class="d-flex">
	  	...
	  	<div class="container-fluid">
		    <div class="text-center my-5 fs-3 fw-bold">Find Course</div>
		    <div class="container border  border-0 border-secondary" >
				<div class="container-fluid">
					<form action="find-course" method="post" class="d-flex mx-auto justify-content-center" style="line-height: 40px; width:50%;">
						<input type="text" name="CourseName" placeholder="Course Name" class="fw-medium fs-5 border rounded me-1" value="${CourseName}"/>
			    	...
			    	<c:if test="${not empty courses}">
					    <div class="container border  border-0 border-secondary" >
						    <div class="text-center my-3">
				   	    		<a class="btn btn-outline-secondary" href="find-course?sort=asc&name=True&CourseName=${CourseName}">AscName</a>
				   	    		<a class="btn btn-outline-secondary" href="find-course?sort=desc&name=True&CourseName=${CourseName}">DescName</a>
				   	    	</div>
