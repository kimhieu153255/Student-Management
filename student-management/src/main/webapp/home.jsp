...
<html>
  ...
  <div class="d-flex">
  	...
  	<div class="container-fluid">
	    <div class="text-center my-5 fs-3 fw-bold">Students</div>
		    <div class="container border  border-0 border-secondary" >
			    <div class="text-center my-3">
	   	    		<a class="btn btn-outline-secondary" href="home?sort=asc&name=True">AscName</a>
	   	    		<a class="btn btn-outline-secondary" href="home?sort=desc&name=True">DescName</a>
	   	    		<a class="btn btn-outline-secondary" href="home?sort=asc&name=False">AscGrade</a>
	   	    		<a class="btn btn-outline-secondary" href="home?sort=desc&name=False">DescGrade</a>
	   	    	</div>
			    <form action="delete-student" method="post">
				    ...
				    <div class="text-center mt-3">
				    	<a class="btn btn-outline-secondary" href="add-student">Add</a>
				    	<input type="submit" class="btn btn-outline-secondary" value="Delete" />
				    	<a class="btn btn-outline-secondary" href="search-student">Edit</a>
				    	<a class="btn btn-outline-secondary" href="find-student">Find</a>
				    </div>
