  ...
  <body>
	  <div class="d-flex">
	  	...
	  	<div class="container-fluid">
		    <div class="text-center my-5 fs-3 fw-bold">Edit Student</div>
		    <div class="container border  border-0 border-secondary" >
				<div class="container-fluid">
					<form action="search-student" method="post" class="d-flex flex-column align-items-center">
						<input type="number" name="Id" placeholder="Student ID" style="line-height: 50px; width: 100%;" class="fw-medium fs-5 mb-3 border rounded px-3"/>
						<input class="btn btn-outline-secondary fw-medium" type="submit" value="Search" style="line-height: 40px; width: 30%;">
					</form>
